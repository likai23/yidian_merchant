...
public class YdshCodeGenerator {
    // 基础信息：项目名、作者、版本
    public static final String PROJECT = "ydsh-saas-service-merchant";
    public static final String AUTHOR = "戴艺辉";
    public static final String VERSION = "V1.0";
    // 数据库连接信息：连接URL、用户名、秘密、数据库名
    public static final String URL = "jdbc:mysql://192.168.0.251:3306/ydsh_merchant?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=UTC";
    public static final String NAME = "elife-dev";
    public static final String PASS = "Elife@2019";
    public static final String DATABASE = "ydsh_merchant";
    // 路径信息，分开路径方便聚合工程项目，微服务项目
    public static final String BASE_PACKAGE="com.ydsh.merchant.web";
    ...
    public static void main(String[] args) {
       ...
       // generateByAll(bi);
        //单表生成
        generateByTable(bi,"supplier_data","表注释");
    }
